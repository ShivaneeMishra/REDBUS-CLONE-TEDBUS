...
throw new Error('Method not implemented.');
  ...
  imageArr = [
    ...
    },
    {
      ...
      images: 'https://gos3.ibcdn.com/img-1713444352.jpg',
    },
    {
      _id: {
        $oid: '6049b8a97501a24470b9a52b',
      },
      images: 'https://tiimg.tistatic.com/fp/1/003/177/bus-ticket-booking-service-969.jpg',
    },
    {
      _id: {
  ...
  if (loggedinuserjson) {
    ...
    const selectedImage = this.imageArr[randomindex];
    this.randomimage = selectedImage?.images ?? '';
  ...
  loadUserBookings(): void {
    this.notificationService.getBookings(this.userId).subscribe((res: any) => {
      console.log('my trip data');
      this.myBookings = res;
      this.cdr.detectChanges();
    });
  }
  toggleScheduleForm(tripId: string) {
  ...
  submitScheduleAndUpdate(bookingId: string) {
    const updatedData = {
      departureDetails: {
        city: this.newCity,
        time: this.newTime,
